...
class Text extends Field {
	 ...
	 * Set Default.
	 *
	 * @param string|int|array $default Default value.
	 *
	 * @return Settings_Element
	 */
	public function set_default( $default ): Settings_Element {
	 ...
	 * @return Settings_Element
	 */
	public function set_placeholder( string $placeholder ): Settings_Element {
